...
2. Convert the JAX model to PyTorch format using our PolicyModel model
...
import gaussiandream.models.gemma
import gaussiandream.models.model
import gaussiandream.models.pi0_config
import gaussiandream.models_pytorch.policy
from gaussiandream.training import utils
...
def slice_initial_orbax_checkpoint(checkpoint_dir: str, restore_precision: str | None = None):
    ...
    params = gaussiandream.models.model.restore_params(
...
def convert_pi0_checkpoint(
    checkpoint_dir: str, precision: str, output_path: str, model_config: gaussiandream.models.pi0_config.Pi0Config
):
    """
    ...
    action_expert_config = gaussiandream.models.gemma.get_config("gemma_300m")
    ...
    # Instantiate model
    pi0_model = gaussiandream.models_pytorch.policy.PolicyModel(model_config)
...
def main(
    ...
    *,
    ...
    if not isinstance(model_config, gaussiandream.models.pi0_config.Pi0Config):
