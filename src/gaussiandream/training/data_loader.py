...
from gaussiandream.training.droid_rlds_dataset import DroidRldsDataset
...
class RLDSDataLoader:
    """Shallow wrapper around the DROID data loader to make it compatible with GaussianDream.
