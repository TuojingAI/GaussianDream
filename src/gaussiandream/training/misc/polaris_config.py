...
def get_polaris_configs():
    ...
    from gaussiandream.training.config import AssetsConfig
    from gaussiandream.training.config import RLDSDroidDataConfig
    from gaussiandream.training.config import SimpleDataConfig
    from gaussiandream.training.config import TrainConfig
    ...
    return [
        ...
        # GaussianDream doesn't support finetuning of binning policies, so this is an inference-only config
        TrainConfig(
