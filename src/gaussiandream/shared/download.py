...
_GAUSSIANDREAM_DATA_HOME = "GAUSSIANDREAM_DATA_HOME"
_OPENPI_DATA_HOME = "OPENPI_DATA_HOME"
DEFAULT_CACHE_DIR = "~/.cache/gaussiandream"

logger = logging.getLogger(__name__)


def get_cache_dir() -> pathlib.Path:
    cache_root = os.getenv(_GAUSSIANDREAM_DATA_HOME) or os.getenv(_OPENPI_DATA_HOME, DEFAULT_CACHE_DIR)
    cache_dir = pathlib.Path(cache_root).expanduser().resolve()
