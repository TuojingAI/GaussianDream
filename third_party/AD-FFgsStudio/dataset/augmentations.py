...
def random_crop_borders(shape, scale=(0.6,1.0), ratio=(0.75,1.33)):
    ...
    # Randomly select scale and ratio
    ...
    # Calculate width and height based on the actual image aspect ratio
    # Use the actual image ratio to determine crop dimensions
    image_ratio = image_width / image_height
    
    # Adjust the crop dimensions based on both the target ratio and image ratio
    ...
    # Calculate borders as (left, top, right, bottom)
    borders = (x, y, x + w, y + h)
...
def resize_sample_image_and_intrinsics(sample, shape,
    ...
    for key in filter_dict(sample, [
        ...
        intrinsics[0] *= out_w*1.0 / orig_w
        intrinsics[1] *= out_h*1.0 / orig_h
